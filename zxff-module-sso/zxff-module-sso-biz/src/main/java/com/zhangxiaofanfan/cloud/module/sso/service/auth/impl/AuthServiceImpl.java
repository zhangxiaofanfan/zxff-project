package com.zhangxiaofanfan.cloud.module.sso.service.auth.impl;
...
import com.zhangxiaofanfan.cloud.module.common.util.validation.ValidationUtils;
import com.zhangxiaofanfan.cloud.module.sso.api.logger.dto.LoginLogCreateReqDTO;
import com.zhangxiaofanfan.cloud.module.sso.api.sms.SmsCodeApi;
...
import com.zhangxiaofanfan.cloud.module.sso.convert.auth.AuthConvert;
...
import com.zhangxiaofanfan.cloud.module.sso.enums.logger.LoginLogTypeEnum;
import com.zhangxiaofanfan.cloud.module.sso.enums.logger.LoginResultEnum;
import com.zhangxiaofanfan.cloud.module.sso.enums.oauth2.OAuth2ClientConstants;
import com.zhangxiaofanfan.cloud.module.sso.enums.sms.SmsSceneEnum;
import com.zhangxiaofanfan.cloud.module.sso.service.auth.AuthService;
import com.zhangxiaofanfan.cloud.module.sso.service.logger.LoginLogService;
import com.zhangxiaofanfan.cloud.module.sso.service.member.MemberService;
...
import static com.zhangxiaofanfan.cloud.module.common.util.servlet.ServletUtils.getClientIP;
import static com.zhangxiaofanfan.cloud.module.sso.enums.ErrorCodeConstants.AUTH_LOGIN_BAD_CREDENTIALS;
import static com.zhangxiaofanfan.cloud.module.sso.enums.ErrorCodeConstants.AUTH_LOGIN_CAPTCHA_CODE_ERROR;
import static com.zhangxiaofanfan.cloud.module.sso.enums.ErrorCodeConstants.AUTH_LOGIN_USER_DISABLED;
import static com.zhangxiaofanfan.cloud.module.sso.enums.ErrorCodeConstants.AUTH_MOBILE_NOT_EXISTS;
import static com.zhangxiaofanfan.cloud.module.sso.enums.ErrorCodeConstants.AUTH_THIRD_LOGIN_NOT_BIND;
...
public class AuthServiceImpl implements AuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${zxff.captcha.enable:false}")
    ...
    public AuthLoginRespVO socialLogin(AuthSocialLoginReqVO reqVO) {
        ...
        SocialUserRespDTO socialUser = socialUserService.getSocialUserByCode(
                UserTypeEnum.ADMIN.getValue(), reqVO.getType(), reqVO.getCode(), reqVO.getState()
        );
        ...
        // 获得用户
        UserDO user = userService.getUser(socialUser.getUserId());
        if (user == null) {
            throw exception(USER_NOT_EXISTS);
        }
