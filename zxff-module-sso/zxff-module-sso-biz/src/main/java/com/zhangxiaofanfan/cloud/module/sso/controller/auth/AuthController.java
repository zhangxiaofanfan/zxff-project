package com.zhangxiaofanfan.cloud.module.sso.controller.auth;
...
import static com.zhangxiaofanfan.cloud.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
@Validated
@RestController
@ApiSupport(author = "zhangxiaofanfan")
@Tag(name = "认证模块 - 登录/退出服务")
...
public class AuthController {
    ...
    @ApiOperationSupport(author = "zhangxiaofanfan")
    @PostMapping("/demo")
    @PermitAll
    @Operation(summary = "demo 方法")
