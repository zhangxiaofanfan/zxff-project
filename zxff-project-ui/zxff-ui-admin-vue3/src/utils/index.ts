 ...
 * @return 格式化后的数量
 */
export const erpNumberFormatter = (num: number | string, digit: number) => {
  if (num === null) {
    return ''
  }
 ...
 * @return 格式化后的数量
 */
export const erpCountInputFormatter = (num: number | string) => {
 ...
 * @return 格式化后的数量
 */
export const erpPriceInputFormatter = (num: number | string) => {
