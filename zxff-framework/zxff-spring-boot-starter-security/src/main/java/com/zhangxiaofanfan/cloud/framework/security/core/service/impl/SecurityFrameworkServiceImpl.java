package com.zhangxiaofanfan.cloud.framework.security.core.service.impl;
...
import static com.zhangxiaofanfan.cloud.module.common.util.cache.CacheUtils.buildCache;
...
public class SecurityFrameworkServiceImpl implements SecurityFrameworkService {
            ...
            new CacheLoader<KeyValue<Long, List<String>>, Boolean>() {
                ...
                public Boolean load(KeyValue<Long, List<String>> key) {
                    return permissionApi
                            .hasAnyRoles(key.getKey(), key.getValue().toArray(new String[0]))
                            .getCheckedData();
                }
    ...
    private final LoadingCache<KeyValue<Long, List<String>>, Boolean> hasAnyPermissionsCache = buildCache(
            ...
            new CacheLoader<>() {
                ...
                public Boolean load(KeyValue<Long, List<String>> key) {
                    return permissionApi
                            .hasAnyPermissions(key.getKey(), key.getValue().toArray(new String[0]))
                            .getCheckedData();
                }
