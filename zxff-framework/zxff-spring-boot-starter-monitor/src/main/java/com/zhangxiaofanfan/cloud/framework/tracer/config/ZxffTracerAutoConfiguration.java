...
import com.zhangxiaofanfan.cloud.framework.tracer.core.aop.BizTraceAspect;
import com.zhangxiaofanfan.cloud.framework.tracer.core.filter.TraceFilter;
 ...
 * @date 2024-07-04 16:43:12
 */
@AutoConfiguration
@ConditionalOnClass({BizTraceAspect.class})
@EnableConfigurationProperties(TracerProperties.class)
@ConditionalOnProperty(prefix = "zxff.tracer", value = "enable", matchIfMissing = true)
public class ZxffTracerAutoConfiguration {
